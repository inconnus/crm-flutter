...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const double topSpacePixels = 325;
        ...
        children: [
          ...
          ValueListenableBuilder(
            ...
            builder: (context, value, child) {
              return Transform.translate(
                offset: Offset(0, value), // ขยับตามค่าที่คำนวณ
                                  ...
                                  return AspectRatio(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: ShapeDecoration(
                                        ...
                                        shadows: [
                                          BoxShadow(color: Colors.grey.withAlpha(100), spreadRadius: 2, blurRadius: 5, offset: const Offset(0, 0)),
                                        ],
          ...
          NotificationListener<DraggableScrollableNotification>(
            onNotification: (notification) {
              // คำนวณหา "ระยะที่ขยับไปจากจุดเริ่มต้น"
              double delta = notification.extent - initialFraction;

              // เอาส่วนต่างมาคูณความเร็วที่ต้องการ (เช่น -200)
              // ถ้า delta เป็น 0 (ตอนเริ่ม) ค่า offset ก็จะเป็น 0 ไม่วาร์ปแน่นอน
              _parallaxOffset.value = delta * -200;
              return true;
            },
